...
1_tiamat_05.gat,33,120,0	script	area#k131	45,2,2,{/* 177 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_05.gat,25,37,0		script	area#k122	45,2,2,{/* 178 */}
1_tiamat_05.gat,111,48,0	script	area#k1271	45,2,2,{/* 179 */}
1_tiamat_05.gat,42,129,0	script	area#k132	45,2,2,{/* 180 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_08.gat,53,13,0		script	area#k652	45,2,2,{/* 259 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,96,51,0		script	area#k661	45,2,2,{/* 260 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,225,13,0	script	area#k672	45,2,2,{/* 261 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,96,4,0		script	area#k664	45,2,2,{/* 262 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,176,271,0	script	area#k373	45,2,2,{/* 263 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,217,191,0	script	area#k504	45,2,2,{/* 264 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,209,213,0	script	area#k503	45,2,2,{/* 265 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,176,98,0	script	area#k544	45,2,2,{/* 266 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,88,354,0	script	area#k703	45,2,2,{/* 267 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,53,99,0		script	area#k522	45,2,2,{/* 268 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,88,130,0	script	area#k533	45,2,2,{/* 269 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_08.gat,88,271,0	script	area#k363	45,2,2,{/* 270 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_12.gat,183,41,0	script	area#k191	45,2,2,{/* 383 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_13.gat,91,34,0	script	area#k44	45,2,2,{/* 434 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_13.gat,69,33,0	script	area#k45	45,2,2,{/* 435 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_17.gat,60,91,0	script	area#k451	45,2,2,{/* 472 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_18.gat,49,11,0	script	area#k461	45,2,2,{/* 483 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_18.gat,49,89,0	script	area#k462	45,2,2,{/* 484 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_22.gat,52,105,0	script	area#k763	45,2,2,{/* 517 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_25.gat,23,144,0	script	area#k641	45,2,2,{/* 579 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_26.gat,47,93,0		script	area#k1301	45,2,2,{/* 598 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_26.gat,130,112,0	script	area#k1302	45,2,2,{/* 599 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_26.gat,90,92,0		script	area#k1303	45,2,2,{/* 600 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_44.gat,82,121,0	script	area#k1584	45,2,2,{/* 1071 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_50.gat,160,139,0	script	area#k22	45,2,2,{/* 1141 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_50.gat,114,163,0	script	area#k24	45,2,2,{/* 1142 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
1_tiamat_54.gat,230,141,0	script	area#r1684	45,2,2,{/* 1216 */
	if(readparam(bVit) < 110) {
		...
		misceffect 52,""; //self
		misceffect 257,""; //self
		unittalk getcharid(3),strcharinfo(0)+" : 結界を通り抜けるにはVITが「110」以上必要だ……。",1;
		end;
	}
...
1_tiamat_54.gat,286,120,0	script	area#r1692	45,2,2,{/* 1218 */
	if(readparam(bVit) < 130) {
		...
		misceffect 52,""; //self
		misceffect 257,""; //self
		unittalk getcharid(3),strcharinfo(0)+" : 結界を通り抜けるにはVITが「130」以上必要だ……。",1;
		end;
	}
...
1_tiamat_54.gat,290,69,0	script	area#k1693	45,2,2,{/* 1221 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_54.gat,294,69,0	script	area#k1651	45,2,2,{/* 1222 */}
1_tiamat_54.gat,286,120,0	script	area#k1692	45,2,2,{/* 1223 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_54.gat,290,121,0	script	area#k1671	45,2,2,{/* 1224 */}
1_tiamat_54.gat,30,50,0		script	area#k1622	45,2,2,{/* 1225 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_54.gat,59,131,0	script	area#k1624	45,2,2,{/* 1226 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
1_tiamat_54.gat,230,141,0	script	area#k1684	45,2,2,{/* 1227 */ unittalk getcharid(3),strcharinfo(0)+" : 鍵がかかっている……",1; }
...
OnInit:
	areasetcell "1_tiamat_39.gat",10,175,13,181,0;	//鐘楼B1F
	areasetcell "1_tiamat_39.gat",6,178,9,181,0;	//鐘楼B1F

	areasetcell "1_tiamat_45.gat",18,6,38,15,0;	//城壁通路01
	areasetcell "1_tiamat_45.gat",38,10,43,15,0;	//城壁通路01
	areasetcell "1_tiamat_45.gat",10,16,16,85,0;	//城壁通路03

	areasetcell "1_tiamat_46.gat",58,153,86,161,0;	//城壁通路02
	areasetcell "1_tiamat_46.gat",90,165,96,232,0;	//城壁通路04

	areasetcell "1_tiamat_48.gat",10,9,18,52,0;	//城壁通路05
	areasetcell "1_tiamat_48.gat",33,64,67,69,0;	//城壁通路07

	areasetcell "1_tiamat_49.gat",35,282,78,286,0;	//城壁通路08
	areasetcell "1_tiamat_49.gat",90,220,96,267,0;	//城壁通路06
//	end;
//OnStart:
	initnpctimer;
	end;
