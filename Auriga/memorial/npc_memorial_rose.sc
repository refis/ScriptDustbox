...
1@lab.gat,37,37,3	script	スイッチ128#rose	844,{/* 61652 */
...
1@lab.gat,39,37,3	script	スイッチ64#rose	844,{/* 61653 */
	set '@name$,strnpcinfo(0);
	mes "[" +'@name$+ "]";
	mes "現在このスイッチの状態は" +('flag? "ON": "OFF")+ "です。";
	next;
...
1@lab.gat,41,37,3	script	スイッチ32#rose	844,{/* 61654 */
	set '@name$,strnpcinfo(0);
	mes "[" +'@name$+ "]";
	mes "現在このスイッチの状態は" +('flag? "ON": "OFF")+ "です。";
	next;
...
1@lab.gat,43,37,3	script	スイッチ16#rose	844,{/* 61655 */
	set '@name$,strnpcinfo(0);
	mes "[" +'@name$+ "]";
	mes "現在このスイッチの状態は" +('flag? "ON": "OFF")+ "です。";
	next;
...
1@lab.gat,46,37,3	script	スイッチ8#rose	844,{/* 61656 */
	set '@name$,strnpcinfo(0);
	mes "[" +'@name$+ "]";
	mes "現在このスイッチの状態は" +('flag? "ON": "OFF")+ "です。";
	next;
...
1@lab.gat,48,37,3	script	スイッチ4#rose	844,{/* 61657 */
	set '@name$,strnpcinfo(0);
	mes "[" +'@name$+ "]";
	mes "現在このスイッチの状態は" +('flag? "ON": "OFF")+ "です。";
	next;
...
1@lab.gat,50,37,3	script	スイッチ2#rose	844,{/* 61658 */
	set '@name$,strnpcinfo(0);
	mes "[" +'@name$+ "]";
	mes "現在このスイッチの状態は" +('flag? "ON": "OFF")+ "です。";
	next;
...
1@lab.gat,52,37,3	script	スイッチ1#rose	844,{/* 61659 */
	set '@name$,strnpcinfo(0);
	mes "[" +'@name$+ "]";
	mes "現在このスイッチの状態は" +('flag? "ON": "OFF")+ "です。";
	next;
...
1@lab.gat,45,32,3	script	主任研究員#pa0829	865,{/* 61660 */
	...
	mes "[主任研究員]";
	mes "本日の立ち入り許可コードは";
	mes "^0000ff" +getvariableofnpc('code,getmdnpcname("メインスイッチ#rose"))+ "^000000です。";
	mes "許可コードを2進数に変換して、";
	mes "私の後ろにあるスイッチに";
	mes "入力してください。";
	next;
...
OnTimer1000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : さて、それじゃそろそろ始めますかね？　Dr.ベリーニはまだですか？";
	end;
OnTimer5000:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : おそらく最終チェックの途中だと思います。なにせ規模の大きな実験ですから。";
	end;
OnTimer9000:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : 完成後、実稼動を含めた初めての実験ですからね、慎重にもなります。";
	end;
OnTimer13000:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : あ～！　とっとと終わらせてキンキンに冷えたマステラ酒が飲みたい！";
	end;
OnTimer16000:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : あー私も！　ご一緒させてください！";
	end;
OnTimer22000:
	announce "??? : ……ア～……ア……テス……マイクテストです。",0x9,0x00ff77,0x190,12,0,0;
	end;
OnTimer24000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : いらしたようだ。";
	end;
OnTimer26500:
...
OnTimer41500:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : はぁ……やっぱりなんだかイヤな予感がする……";
	end;
OnTimer44500:
	announce "ロゼ・ベリーニ : 研究主任のDr.フェデリコ、アルテミア、シルビア、ヴィンセントおよび補助研究員は実験を開始してください。",0x9,0x00ff77,0x190,12,0,0;
	end;
OnTimer49500:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : 個人保護リアクター稼動を確認……実験開始します。";
...
OnTimer52500:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : ジェネレーター稼動、開始。";
	end;
OnTimer53500:
...
OnTimer55500:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : ジェネレーター回転率を10,000RPMに固定。";
	end;
OnTimer56500:
	donpcevent getmdnpcname("#eff_event1")+ "::OnEff5";
	end;
OnTimer57500:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : サイクロトロン内電圧、許容範囲内に収まっています。";
	end;
OnTimer58000:
...
OnTimer71500:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : ……第1触媒装置、接続を開始。";
	end;
OnTimer80500:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : ジェネレーター電圧、不安定ですがまだ許容範囲です。";
	end;
OnTimer83500:
	donpcevent getmdnpcname("#eff_event2")+ "::OnEff1";
	end;
OnTimer85500:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : !?　待ってください!!　加速器と触媒装置間で熱反応感知しました！　……ですが、許容範囲内です。";
...
OnTimer90500:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : 加速器内の温度上昇中。";
	end;
OnTimer91000:
...
OnTimer96000:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : ……320度";
	end;
OnTimer96500:
...
OnTimer101000:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : ……670度、加熱速度が想定外の速さです！";
	end;
OnTimer103500:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : 1000度を越えました！　Dr.ベリーニ!!装置の停止を提案します！";
	end;
OnTimer106300:
	announce "ロゼ・ベリーニ : いいえ、問題ありません。",0x9,0x00ff77,0x190,12,0,0;
	end;
OnTimer111000:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : 私からも提案します！　既に予想範囲内を軽くオーバーしているんです！";
	end;
OnTimer114000:
	announce "ロゼ・ベリーニ : 想定内です、現状維持を。",0x9,0x00ff77,0x190,12,0,0;
	end;
OnTimer116750:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : （狂ってる……）";
	end;
OnTimer122000:
	announce "MA-4885 : メインサーバーの変動状況を確認。粒子加速器および触媒装置間の次元湾曲反応を感知。",0x9,0xffff00,0x190,13,0,0;
	end;
OnTimer124500:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : Dr.ベリーニ！　マザーコンピューターの危険状況と判断します！　主電源を落としてください！";
	end;
OnTimer130000:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : いったい何が起きてるんだ！　誰でもいいからあのポンコツの電源を落とせ！";
	end;
OnTimer133000:
...
OnTimer147500:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : MA-4885！　勝手に再稼動なんて！　誰もオーダーは出してないわよ！";
	end;
OnTimer150500:
	announce "MA-4885 : オーダー、Dr.アルテミアと確認。承認不可能な命令です。",0x9,0xffff00,0x190,13,0,0;
	end;
OnTimer156500:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : うそ！　……Dr.ベリーニ！　今すぐに実験をやめるべきです！";
	end;
OnTimer159500:
	announce "ロゼ・ベリーニ : ……。",0x9,0x00ff77,0x190,12,0,0;
	end;
OnTimer162500:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : くそ！　時間がないんだ！　マザーコンピューターの電源を落と……";
	end;
OnTimer165500:
	announce "MA-4885 : 粒子加速器の再稼動を第1段階より再度開始。",0x9,0xffff00,0x190,13,0,0;
	end;
OnTimer168500:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : ……ベリーニ！　決断して！";
	donpcevent getmdnpcname("#eff_event1")+ "::OnEff1";
	end;
OnTimer170500:
	donpcevent getmdnpcname("#eff_event1")+ "::OnEff2";
...
OnTimer199000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : ダメか…！　くそ！　また何か来るぞ！";
	end;
OnTimer199500:
	donpcevent getmdnpcname("#eff_event2")+ "::OnEff9";
	end;
...
OnTimer201000:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : あ～～だから最新型のA.I.CPUなんて付けるんじゃなかったんだよ！";
	end;
OnTimer204000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : 体が……うごか……ない……";
	end;
OnTimer208000:
	donpcevent getmdnpcname("#eff_event1")+ "::OnStop";
	donpcevent getmdnpcname("#eff_event2")+ "::OnStop";
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : ……さっきと同じね、一体何が起きているの？";
	end;
OnTimer212000:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : どうでもいいよ、そんなの！　今のうちにあのポンコツを止めるぞ！";
	end;
OnTimer217000:
...
OnTimer232000:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : あのポンコツの塊、何を考えてるの!?　異次元の生物と交流ですって!?";
	end;
OnTimer236000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : 生まれて始めて神に祈りをささげよう……。神よ！　ポンコツを止めてください！";
	end;
OnTimer242000:
...
OnTimer254000:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : Dr.ベリーニ！　この実験は私たちが設定したものとは全く違います！";
	end;
OnTimer260000:
	announce "ロゼ・ベリーニ : わかっています。",0x9,0x00ff77,0x190,12,0,0;
	end;
OnTimer266000:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : 主電力は落とせないの!?";
	end;
OnTimer272000:
...
OnTimer288000:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : これで！　あとは主電力さえ落ちれば……！";
	end;
OnTimer288500:
	donpcevent getmdnpcname("#eff_event1")+ "::OnEff8";
	end;
...
OnTimer310000:
	donpcevent getmdnpcname("#eff_event1")+ "::OnStop";
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : ふう……終わったのでしょうか？";
	end;
OnTimer316000:
	announce "ロゼ・ベリーニ : マザーコンピューターMA-4885への電力供給を停止完了。装置停止を確認。",0x9,0x00ff77,0x190,12,0,0;
	end;
OnTimer321000:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : ……本当に終わったみたいですね。";
	end;
OnTimer325000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : あのポンコツ、CPUごとぶち抜いてやる……！";
	end;
OnTimer329000:
...
OnTimer344000:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : 終了ですね。";
	end;
OnTimer349000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : ベリーニの独断で行われた実験だと思ってたが、MA-4885の方に問題があったようですね。";
	end;
OnTimer354500:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : まずは後片付けをして……早くここから出ましょう！";
	end;
OnTimer359500:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : ところでさあ……お前ら体、動くか？";
	end;
OnTimer364500:
	donpcevent getmdnpcname("#eff_event1")+ "::OnEff1";
...
OnTimer371500:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : 何だ！　どうなってるんだ!!　終わったんじゃなかったのか!?";
	end;
OnTimer372000:
	donpcevent getmdnpcname("#eff_event1")+ "::OnEff5";
	misceffect 90,getmdnpcname("#centrallab_gen_11");
...
OnTimer377000:
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : そんな……私のマステラ酒……！　たれ付き焼き肉……！";
	donpcevent getmdnpcname("#eff_event1")+ "::OnEff9";
	end;
OnTimer378000:
	donpcevent getmdnpcname("#eff_event1")+ "::OnStart";
...
OnTimer396000:
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : MA-4885は俺達が想定していた以上の実験をしようとしてる……。";
	end;
OnTimer396500:
...
OnTimer398000:
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : ははっ、機械のくせに人間様を出し抜こうとはな……。Dr.ベリーニ！　聞こえるか？　非常警報を作動してくれ！";
	end;
OnTimer398500:
...
OnTimer403500:
	misceffect 90,getmdnpcname("#centrallab_gen_13");
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : ……いいだろ？　みんな。少なくとも他の実験室まで巻き込むわけには行かない。";
	end;
OnTimer405000:
	misceffect 90,getmdnpcname("#centrallab_gen_14");
	end;
...
OnTimer413000:
	misceffect 90,getmdnpcname("#centrallab_gen_14");
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : まあ、どうなるかなんてまだ分からないですよ？　それに次元移動を直接経験なんて！　うーっ！　楽しみ！";
	end;
OnTimer415000:
	misceffect 90,getmdnpcname("#centrallab_gen_11");
	end;
...
OnTimer418000:
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : ……新物質生成が次元移動なんてね……レベルが違う実験だけどね、ふふ。";
	end;
OnTimer419000:
	misceffect 90,getmdnpcname("#centrallab_gen_13");
	end;
...
OnTimer438000:
	...
	unittalk getmdnpcname("Dr.フェデリコ#pa0829"),"フェデリコ : ……へえ、これが次元移動か……。うん、確かに初めてだな。この感じ。";
	end;
OnTimer439000:
	misceffect 90,getmdnpcname("#centrallab_gen_11");
	end;
...
OnTimer442000:
	...
	unittalk getmdnpcname("Dr.ヴィンセント#pa0829"),"ヴィンセント : 他の研究員はちゃんと逃げたかな……";
	donpcevent getmdnpcname("#eff_event2")+ "::OnEff1";
	end;
OnTimer443000:
	misceffect 90,getmdnpcname("#centrallab_gen_13");
...
OnTimer447000:
	...
	unittalk getmdnpcname("Dr.アルテミア#pa0829"),"アルテミア : 一度も恋したことが無いのはちょっと悔しいかな……。";
	end;
OnTimer448000:
	donpcevent getmdnpcname("#eff_event2")+ "::OnEff4";
	end;
...
OnTimer452000:
	...
	unittalk getmdnpcname("Dr.シルビア#pa0829"),"シルビア : ……ああ～。こんないい経験には冷たいマステラ酒とたれ付き焼き肉が欲しかったな。";
	end;
OnTimer452500:
	donpcevent getmdnpcname("#eff_event2")+ "::OnEff7";
	end;
