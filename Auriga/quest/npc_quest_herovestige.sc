...
dali.gat,68,129,3	script	案内板#dali	837,{
	mes "[インフォメーション]";
	mes "この先";
...
dali02.gat,70,98,3	script	案内板#dali02	837,{
	mes "[インフォメーション]";
	mes "魔神の塔の入場口を";
	mes "コンパスに表示しますか？";
	mes "　";
...
dali02.gat,51,112,5	script	混乱に陥ったシーフ#cr	939,{
	mes "[混乱に陥ったシーフ]";
	mes "酒に酔った奴らから金品を";
	mes "盗んでいたら、いつの間にか";
	mes "こんなところに出たんだ。";
...
dali02.gat,68,117,5	script	案内人レシア族#cr	516,{
	mes "[案内人レシア族]";
	mes "また、ここに出てしまった。";
	mes "出口も見えないなんて……";
	mes "まったく……";
...
dali02.gat,65,119,5	script	観光客レシア族#cr#	516,{
	mes "[観光客レシア族]";
	mes "ここがあの有名なプロンテラか？";
	mes "やはり大都市！　薄暗いな！";
	close;
...
dali02.gat,69,122,5	script	旅行中レシア族#cr#	516,{
	mes "[旅行中レシア族]";
	mes "時計の音が聞こえる暗い場所！";
	mes "ここは絶対コモドだよ！";
	close;
...
dali02.gat,65,115,5	script	冒険好きレシア族#cr#	516,{
	mes "[冒険好きレシア族]";
	mes "みんな、武器を取れ！";
	mes "僕たちはタナトスタワーの";
	mes "真っ只中なんだ！";
...
dali02.gat,45,96,6	script	コンチネンタルガード#ep	707,{
	mes "[コンチネンタルガード]";
