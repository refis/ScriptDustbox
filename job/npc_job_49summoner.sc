...
do_tu01e.gat,134,381,0	script	warp01#do_tu01e	45,2,2,{/* 52825 */
	...
	if(DORAM_1QUE <= 1)
		warp "do_tu01e.gat",29,281;
	else if(DORAM_1QUE <= 22)
		warp "do_tu01e.gat",60,320;
	else
		warp "do_tu02e.gat",153,58;
	end;
}
...
do_tu01e.gat,60,322,3	script	自警団員アリオ#do_tu01e	10154,{/* 52828 */
	...
	case 9:
		...
		close;
	case 10:
		if(getskilllv() == 0) {		// かみつくスキル
			mes "[自警団員アリオ]";
			if(getskilllv() == 0) {		// ドラム基本スキル
				mes "どちらのスキルもまだ";
				mes "取得できていないぞ？";
			}
			else {
...
do_tu01e.gat,52,323,4	script	旅の行商人#do_tu01e	10163,{/* 52829 */
	if(DORAM_1QUE < 18) {
		mes "[旅の行商人]";
		mes "オイラは旅の行商人さ。";
		mes "でも、キミには何も売れないよ。";
...
do_tu01e.gat,62,320,3	script	道具屋の末っ子#do_tu01e	10167,{/* 52830 (cloaking)*/
	end;
OnTalk1:
...
do_tu01e.gat,66,323,4	script	旅の鍛冶屋#do_tu01e	10163,{/* 52831 */
	if(DORAM_1QUE < 14) {
		mes "[旅の鍛冶屋]";
		mes "オレは旅の鍛冶屋だ。";
		mes "残念だがアリオの兄ちゃんの";
...
do_tu02e.gat,205,327,0	script	warp03#do_tu02e	45,2,2,{/* 52834 */
	...
	default:
		...
		if(DORAM_1QUE <= 1)
			...
			warp "do_tu05e.gat",55,61;
		end;
	}
}
do_tu02e.gat,153,58,0	script	object01#do_tu02e	139,3,3,{/* 52835 */
	if(DORAM_1QUE == 23) {
		mes "^009eff【インフォメーション】";
		mes "クエストウィンドウには";
		mes "行き先や目標が書いてあります。";
...
do_tu02e.gat,224,126,5	script	治療師ハル#do_tu02e	10164,{/* 52836 */
	if(distance(getcharid(3)) > 5) {
		showmessage "‐もっと近づいてから話しかけよう‐","";
		end;
	}
	...
	case 23:
		delquest 98413;
		getexp 87,1600;
		savepoint "do_tu02e.gat",224,123;
		set DORAM_1QUE,24;
		mes "^009eff【インフォメーション】";
		mes "セーブポイントを更新しました。";
		mes "戦闘不能になった場合、";
...
do_tu02e.gat,226,124,3	script	道具屋の末っ子#do_tu02e	10167,{/* 52837 (cloaking)*/
	end;
OnTalk1:
...
do_tu02e.gat,230,127,3	script	自警団員アリオ#do_tu02e	10154,{/* 52838 (cloaking)*/
	end;
OnTalk1:
	unittalk "自警団員アリオ : ちょうど用事が済んだようだな。";
	end;
}
do_tu02e.gat,237,197,3	script	自警団員アリオ#do_tu02e	10154,{/* 52839 (cloaking)*/}
do_tu02e.gat,235,198,3	script	ペロン団長#do_tu02e	10152,{/* 52840 */
	if(distance(getcharid(3)) > 5) {
		showmessage "‐もっと近づいてから話しかけよう‐","";
		end;
	}
	...
	case 25:
		delquest 98415;
		getexp 121,2000;
		savepoint "do_tu02e.gat",235,196;
		set DORAM_1QUE,26;
		mes "^009eff【インフォメーション】";
		mes "セーブポイントを更新しました。";
		mes "戦闘不能になった場合、";
...
do_tu02e.gat,203,324,5	script	エッグリン#do_tu02e	10157,{/* 52841 */
	if(distance(getcharid(3)) > 5) {
		showmessage "‐もっと近づいてから話しかけよう‐","";
		end;
	}
...
do_tu03e.gat,59,90,5	script	ペロン団長#do_tu03e	10152,{/* 52842 */
	switch(DORAM_1QUE) {
	case 29:
		if(checkquest(98417)) {
			delquest 98417;
...
do_tu04e.gat,348,244,0	script	warp02#do_tu04e	45,2,2,{/* 52846 */
	...
	warp "do_tu06e.gat",24,143;
	end;
}
do_tu04e.gat,20,98,0	script	object01#do_tu04e	139,3,3,{/* 52847 */
	if(DORAM_1QUE == 27) {
		mes "^009eff【インフォメーション】";
		mes "クエストウィンドウには";
		mes "行き先や目標が書いてあります。";
...
do_tu05e.gat,50,60,0	script	warp02#do_tu05e	45,2,2,{/* 52850 */
	if(DORAM_1QUE <= 35) {
		mes "‐「船長室」と書いてある。";
		mes "　まずは食堂に行こう‐";
		close;
	}
	warp "do_tu05e.gat",30,60;
	end;
}
do_tu05e.gat,36,60,0	warp	warp03#do_tu05e	2,2,do_tu05e.gat,54,60	//52851 from_pos=(36, 60)
do_tu05e.gat,143,60,0	warp	warp04#do_tu05e	2,2,do_tu05e.gat,165,60	//52852 from_pos=(142, 60)
do_tu05e.gat,159,60,0	warp	warp05#do_tu05e	2,2,do_tu05e.gat,138,60	//52853 from_pos=(160, 60)
do_tu05e.gat,186,57,3	script	料理長#do_tu05e	548,{/* 52854 */
	if(distance(getcharid(3)) > 5) {
		showmessage "‐もっと近づいてから話しかけよう‐","";
		end;
	}
...
do_tu05e.gat,122,61,5	script	船員#do_tu05e_01	559,{/* 52855 */
	mes "[船員]";
	mes "新大陸は初めてですか？";
	mes "一度も行って見たことない場所に";
	mes "行く気分はどうですか？";
...
do_tu05e.gat,169,70,3	script	船員#do_tu05e_02	545,{/* 52856 */
	mes "[船員]";
	mes "ミッドガルドも発見されたけど、";
	mes "他にもあるかな？";
	mes "地図にもない場所。";
...
do_tu05e.gat,166,68,6	script	船員#do_tu05e_03	544,{/* 52857 */
	mes "[船員]";
	mes "ステルロー一等航海士なら";
	mes "地図にもない新大陸への航路を";
	mes "また見つけ出しそうな気がする。";
...
do_tu05e.gat,181,61,5	script	甲板長#do_tu05e	421,{/* 52858 */
	mes "[甲板長]";
	mes "ここの料理長、顔はこええが";
	mes "料理の腕は確かなんだぜ。";
	close;
}
do_tu05e.gat,181,58,3	script	操舵手#do_tu05e	561,{/* 52859 */
	mes "[操舵手]";
	mes "エッグリンのやろう。";
	mes "まーたサボってやがるな。";
	close;
}
do_tu05e.gat,26,64,5	script	ガムベリー船長#do_tu05e	10153,{/* 52860 */
	if(distance(getcharid(3)) > 5) {
		showmessage "‐もっと近づいてから話しかけよう‐","";
		end;
	}
...
do_tu05e.gat,24,62,5	script	ステルロー#do_tu05e	10156,{/* 52861 */
	if(DORAM_1QUE < 38) {
		mes "[ステルロー]";
		mes "俺はステルロー。";
		mes "この船の航海士をやっている。";
...
do_tu05e.gat,22,60,5	script	甲板長#do_tu05e_2	421,{/* 52863 (cloaking)*/
	mes "[甲板長]";
	mes "時間が経ち過ぎると";
	mes "積み荷が駄目になっちまうからな。";
	mes "早く何とかしてほしいもんだぜ。";
...
do_tu05e.gat,21,56,3	script	操舵手#do_tu05e_2	561,{/* 52864 (cloaking)*/
	mes "[操舵手]";
	mes "いつになったら";
	mes "出航できるのかねえ。";
	close;
...
do_tu06e.gat,18,143,0	warp	warp01#do_tu06e	2,2,do_tu04e.gat,344,243	//52865 from_pos=(18, 143)
do_tu06e.gat,29,146,5	script	自警団員#do_tu06e	10162,{/* 52866 */
	if(distance(getcharid(3)) > 5) {
		showmessage "‐もっと近づいてから話しかけよう‐","";
		end;
	}
...
do_tu06e.gat,153,103,3	script	自警団員#do_tu06e_2	10162,{/* 52867 */
	if(distance(getcharid(3)) > 5) {
		showmessage "‐もっと近づいてから話しかけよう‐","";
		end;
	}
...
do_tu07e.gat,159,156,5	script	自警団員#do_tu07e	10162,{/* 52870 */
	if(DORAM_1QUE < 42) {
		mes "[自警団員]";
		mes "だいぶバジルリスクが増えたな……。";
		next;
...
do_tu07e.gat,162,158,3	script	タルトゥーフィ#do_tu07e	10161,{/* 52871 */
	if(DORAM_1QUE == 39) {
		if(chackquest(98427)) {
			delquest 98427;
			getexp 524,8000;
...
do_tu07e.gat,247,194,0	script	object02#do_tu07e	139,{/* 52824 */}

do_tu02e.gat,226,181,3	script	カルルー#do_tu02e	548,{/* 53236 */
	mes "[カルルー]";
	mes "カルーニャミルクの";
	mes "主な材料を知っているか？";
	mes "カルーニャという特別な貝を";
...
do_tu02e.gat,225,290,5	script	作業班長#do_tu02e	421,{/* 53237 */
	mes "[作業班長]";
	mes "この仕事をやったことある？";
	mes "すぐに覚えられる簡単な事だ。";
	mes "コンキリナ号のガムベリー船長は";
...
do_tu02e.gat,139,299,3	script	イワシ漁船船長#do_tu02e	561,{/* 53238 */
	mes "[イワシ漁船船長]";
	mes "イワシ産業が";
	mes "以前より落ち込んでいても";
	mes "人手は常に不足している。";
...
do_tu02e.gat,263,156,5	script	おばあちゃん#do_tu02e	554,{/* 53239 */
	mes "[おばあちゃん]";
	mes "昔のラザーニャは凄かった。";
	mes "道も住民もボロボロ。";
	mes "当時は暗黒期と呼ばれているよ。";
...
do_tu02e.gat,244,231,3	script	イワシ漁船員#do_tu02e	544,{/* 53240 */
	mes "[イワシ漁船員]";
	mes "この黄色いチーズ道に沿って";
	mes "歩いて行けば、";
	mes "私たちの故郷が現れる。";
...
do_tu02e.gat,260,134,3	script	ラスムス#do_tu02e	546,{/* 53241 */
	mes "[ラスムス]";
	mes "赤い毛糸は君が行きたい場所に";
	mes "連れていってくれるし、";
	mes "黄色い道は君を家に";
...
do_tu02e.gat,141,166,5	script	クルメ#do_tu02e	555,{/* 53242 */
	mes "[クルメ]";
	mes "道を歩いていると悟ることがある。";
	mes "この世界のどこからでも";
	mes "ミートソースの匂いが";
...
do_tu02e.gat,233,174,5	script	酔っ払い#do_tu02e_01	561,{/* 53243 */
	mes "[飲み手]";
	mes "カルーニャミルクは";
	mes "ゆっくり混ぜてから飲まなきゃ。";
	mes "最近ここに来た流れ者たちは";
...
do_tu02e.gat,236,173,3	script	酔っ払い#do_tu02e_02	561,{/* 53244 */
	mes "[飲み手]";
	mes "カルーニャミルクは";
	mes "よく振ってから飲むのが一番だ。";
	mes "発酵されたカルーニャが";
...
do_tu02e.gat,209,301,3	script	ムスタチ#do_tu02e	10167,{/* 53247 */
	mes "[ムスタチ]";
	mes "新大陸に旅立つ前に";
	mes "身だしなみを整えてみては？";
	close;
}
do_tu02e.gat,236,179,5	script	ニャンクン#do_tu02e	10163,{/* 53248 */
	mes "[ニャンクン]";
	mes "困った事があるなら";
	mes "自警団に頼んでみたら？";
	close;
...
do_tu02e.gat,227,187,1	script	ヴォンゴロ#do_tu02e	544,{/* 53252 */
	mes "[ヴォンゴロ]";
	mes "こんにちは。";
	mes "パブ「オーブン」へようこそ。";
	mes "注文は決まりましたか？";
...
do_tu02e.gat,232,187,6	script	フェットゥチーニャ#do_t	545,{/* 53253 */
	mes "[フェットゥチーニャ]";
	mes "ここで働いてそれなりに経つけど、";
	mes "未だに下っ端なので皿洗いは";
	mes "すべて私の担当です。";
...
do_tu02e.gat,232,181,5	script	リンギュイーネ#do_tu02e	559,{/* 53254 */
	mes "[リンギュイーネ]";
	mes "ここは自警団本部ですが、";
	mes "冒険者が立ち寄っていく";
	mes "パブでもあります。";
...
do_tu02e.gat,190,239,5	script	幼いニャンコ#do_tu02e_0	559,{/* 53255 */
	unittalk "幼いニャンコ : 私はこの遊び場の隊長だにゃ～。";
	end;
}
do_tu02e.gat,180,230,7	script	幼いニャンコ#do_tu02e_0	560,{/* 53256 */
	unittalk "幼いニャンコ : ハァ……こんな幼稚なやつらとは一緒に遊べないにゃ～。";
	end;
}
do_tu02e.gat,192,245,7	script	幼いニャンコ#do_tu02e_0	554,{/* 53257 */
	unittalk "幼いニャンコ : 毛玉の塊がひとつ、ななつ、ふたつ、むっつ……多いにゃ!!";
	end;
}
do_tu02e.gat,184,234,5	script	幼いニャンコ#do_tu02e_0	422,{/* 53258 */
...
do_tu02e.gat,211,186,5	script	乗船案内員#do_tu02e	559,{/* 53260 */
	mes "[乗船案内員]";
	mes "こんにちは！";
	mes "新大陸に旅立つ船はここから北の";
	mes "船着き場に停泊していますよ。";
...
do_tu02e.gat,222,187,3	script	ボス#do_tu02e	548,{/* 53261 */
	mes "[ボス]";
	mes "なんだ？";
	mes "あんたもカルーニャミルクかい？";
	close;
}
do_tu02e.gat,202,291,3	script	自警団案内員#do_tu02e01	10162,{/* 53262 */
	mes "[自警団案内員]";
	mes "港町ラザーニャへようこそ！";
	mes "助けが必要な時は";
	mes "いつでもファルファーレ自警団を";
...
do_tu02e.gat,174,160,3	script	自警団案内員#do_tu02e02	10162,{/* 53263 */
	mes "[自警団案内員]";
	mes "こんにちは。";
	mes "良い天気ですにゃ。";
	close;
}
do_tu02e.gat,233,197,5	script	自警団員オリオ#do_tu02e	10155,{/* 53264 */
	mes "[自警団員オリオ]";
	mes "この方はファルファーレ自警団の";
	mes "団長であるペロン様だ！";
	close;
}
do_tu02e.gat,77,263,5	script	タルリー#do_tu02e	10166,{/* 53265 */
	mes "[タルリー]";
	mes "早く仕事を仕上げないと……";
	mes "待ち合わせに間に合わないわ。";
	close;
...
/
lasagna.gat,297,229,4	script	チュートリアル掲示板#01	857,{/* 50117 */}
lasagna.gat,300,242,4	script	カプラ職員#lasagna	117,{/* 50102 */
	if(!checkquest(98440)) {
...
lasagna.gat,305,242,4	script	治療師ハル#lasagna	10164,{/* 50108 */}
lasagna.gat,312,251,4	script	看板#2lasagna	835,{/* 50116 */}

//------------------------------------------------------------
// do_tu01e.gat
do_tu01e.gat,0,0,0,0	monster	エッグリン	3495,30,5000,0,0
do_tu01e.gat,0,0,0,0	monster	グラスファブル	3497,30,5000,0,0
//------------------------------------------------------------
// do_tu04e.gat
do_tu04e.gat,0,0,0,0	monster	スウィートフロッグ	3499,40,5000,0,0
do_tu04e.gat,0,0,0,0	monster	ハンターウルフ	3500,30,5000,0,0
do_tu04e.gat,0,0,0,0	monster	ワイルドホーネット	3498,30,5000,0,0
do_tu04e.gat,0,0,0,0	monster	リーフルナティック	3496,40,5000,0,0
do_tu04e.gat,0,0,0,0	monster	偵察バジルリスク	3502,10,5000,0,0
//------------------------------------------------------------
// do_tu06e.gat
do_tu06e.gat,0,0,0,0	monster	偵察バジルリスク	3502,40,5000,0,0
do_tu06e.gat,0,0,0,0	monster	トランススポア	3501,30,5000,0,0
// do_tu07e.gat
do_tu07e.gat,0,0,0,0	monster	偵察バジルリスク	3502,80,5000,0,0

/*
@spawn(type: BL_MOB, ID: 52879, speed: 400, option: 0, view: 3495, pos: "do_tu01e.gat"(52, 324), dir: 1, name: "エッグリン")
@spawn(type: BL_MOB, ID: 52922, speed: 400, option: 0, view: 3497, pos: "do_tu01e.gat"(78, 314), dir: 6, name: "グラスファブル")

@spawn(type: BL_MOB, ID: 53051, speed: 300, option: 0, view: 3500, pos: "do_tu04e.gat"(123, 188), dir: 2, name: "ハンターウルフ")
@nomalattack(src: "3500:ハンターウルフ:do_tu04e.gat"(53051), dst: , damage: 26, sDelay: 900, dDelay: 792, aDelay: 1617)

@spawn(type: BL_MOB, ID: 52991, speed: 150, option: 0, view: 3498, pos: "do_tu04e.gat"(187, 221), dir: 6, name: "ワイルドホーネット")
@nomalattack(src: "3498:ワイルドホーネット:do_tu04e.gat"(52991), dst: , damage: 21, sDelay: 792, dDelay: 792, aDelay: 1302)

@spawn(type: BL_MOB, ID: 53029, speed: 200, option: 0, view: 3499, pos: "do_tu04e.gat"(210, 207), dir: 3, name: "スウィートフロッグ")
@nomalattack(src: "3499:スウィートフロッグ:do_tu04e.gat"(53029), dst: , damage: 19, sDelay: 816, dDelay: 792, aDelay: 2016)

@spawn(type: BL_MOB, ID: 52936, speed: 200, option: 0, view: 3496, pos: "do_tu04e.gat"(215, 213), dir: 3, name: "リーフルナティック")
@nomalattack(src: "3496:リーフルナティック:do_tu04e.gat"(52936), dst: , damage: 0, sDelay: 456, dDelay: 792, aDelay: 1470)

@spawn(type: BL_MOB, ID: 53075, speed: 300, option: 0, view: 3502, pos: "do_tu04e.gat"(256, 87), dir: 3, name: "偵察バジルリスク")
@nomalattack(src: "3502:偵察バジルリスク:do_tu04e.gat"(53075), dst: , damage: 0, sDelay: 528, dDelay: 792, aDelay: 2246)
*/