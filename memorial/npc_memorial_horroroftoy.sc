...
xmas.gat,242,293,3	script	エンチャント掲示板	857,{
	while(1) {
		mes "‐ホラーおもちゃ工場エンチャントの";
		mes "　詳しい説明が書かれているようだ。";
		mes "　何をみようか？‐";
		next;
		switch(select("エンチャントについて","初期化について","血塗られたコインの必要枚数","やめる")) {
		case 1:
			break;
		case 2:
			mes "[初期化について]";
			mes "ホラーおもちゃ工場エンチャントでは";
			mes "エンチャントした能力を削除し";
			mes "初期化する事が可能です。";
			next;
			mes "[初期化について]";
			mes "初期化は武器、防具のエンチャントに";
			mes "対して行なうことが出来ますが";
			mes "防具のエンチャントを初期化する場合";
			mes "^ff00002段階目までエンチャントが";
			mes "完了している^000000必要があります。";
			next;
			mes "[初期化について]";
			mes "アクセサリーのエンチャントでは";
			mes "任意のタイミングで初期化を";
			...
			next;
			mes "[初期化について]";
			mes "また、初期化は失敗する場合があり";
			mes "初期化に失敗すると、";
			mes "^ff0000アイテムは壊れてしまいます。^000000";
			mes "壊れたアイテムは無くなりますので";
			mes "ご注意ください。";
			next;
			continue;
		case 3:
			...
			mes "[血塗られたコインの必要枚数]";
			mes "血塗られたコインの必要枚数は";
			mes "エンチャント1回につき^0000ff15^000000枚";
			mes "初期化1回につき^0000ff100^000000枚です。";
			next;
			continue;
		case 4:
			mes "‐その場を後にした‐";
		...
		while(1) {
			mes "‐どのアイテムのエンチャントについて";
			mes "　調べようか？‐";
			next;
			switch(select("古い洋傘[3]","シャドウウォーカー[1]","瑞々しいバラ[1]","セリーヌのリボン[1]","赤いランタン[1]","優しい心[1]","傷ついた心[1]","悪霊の糸の手袋[1]","一つ前に戻る","やめる")) {
			case 1:
				mes "[古い洋傘[3]]";
				mes "古い洋傘[3]は";
				mes "4番目のスロットに対しての";
				mes "1段階のみエンチャントをすることが";
				mes "できます。";
				next;
				mes "[古い洋傘[3]]";
				mes "エンチャントには必ず成功し";
				...
				next;
				mes "[古い洋傘[3]]";
				mes "闘志5(Atk+18,Hit+5)";
				mes "闘志6(Atk+21,Hit+5)";
				mes "闘志7(Atk+24,Hit+5)";
				mes "闘志8(Atk+27,Hit+5)";
				mes "闘志9(Atk+30,Hit+5)";
				mes "闘志10(Atk+50,Hit+15)";
				mes "先鋭3(Hit+4,Cri+12)";
				mes "先鋭4(Hit+5,Cri+14)";
				mes "先鋭5(Hit+6,Cri+15)";
				mes "Matk1(Matk+1%,固定詠唱時間-1%)";
				mes "Matk2(Matk+2%,固定詠唱時間-1%)";
				mes "Matk3(Matk+3%,固定詠唱時間-1%)";
				mes "攻撃速度2(攻撃速度+6%)";
				mes "攻撃速度3(攻撃速度+8%)";
				mes "攻撃速度4(攻撃速度+10%)";
				mes "Aspd+1(Aspd+1)";
				mes "魔力6(Matk+21,詠唱時間-10%)";
				mes "魔力7(Matk+24,詠唱時間-10%)";
				mes "魔力8(Matk+27,詠唱時間-10%)";
				mes "魔力9(Matk+30,詠唱時間-10%)";
				next;
				mes "[古い洋傘[3]]";
				mes "以上です。";
				next;
			...
			case 2:
				mes "[シャドウウォーカー[1]]";
				mes "シャドウウォーカー[1]には";
				mes "第1段階として4番目のスロットに、";
				mes "第2段階として3番目のスロットに";
				mes "エンチャントをすることが";
				mes "できます。";
				next;
				mes "[シャドウウォーカー[1]]";
				mes "エンチャントには必ず成功し";
				mes "2段階目までエンチャントした場合";
				mes "初期化する事が可能になります。";
				next;
				mes "[シャドウウォーカー[1]]";
				mes "しかし、初期化に失敗し、";
				mes "^ff0000防具が破壊されてしまう^000000";
				mes "場合があります。";
				mes "破壊されたアイテムは";
				mes "無くなってしまいますので";
				mes "注意してください。";
				...
				next;
				mes "[シャドウウォーカー[1]]";
				mes "闘志3(Atk+12,Hit+4)";
				mes "闘志4(Atk+15,Hit+5)";
				mes "先鋭2(Hit+3,Cri+9)";
				mes "先鋭3(Hit+4,Cri+12)";
				mes "Matk1(Matk+1%,固定詠唱時間-1%)";
				mes "Matk2(Matk+2%,固定詠唱時間-1%)";
			...
			case 3:
				...
				mes "攻撃速度2(攻撃速度+6%)";
				mes "攻撃速度3(攻撃速度+8%)";
				mes "魔力1(Matk+6,詠唱時間-4%)";
				mes "魔力2(Matk+9,詠唱時間-6%)";
				mes "魔力3(Matk+12,詠唱時間-8%)";
				next;
				mes "[瑞々しいバラ[1]]";
				mes "以上です。";
				next;
			...
			case 4:
				...
				mes "初期化する事が可能になります。";
				mes "また、セリーヌのリボン[1]は";
				mes "^0000ff必ず初期化に成功します^000000。";
				next;
				mes "[セリーヌのリボン[1]]";
				mes "セリーヌのリボン[1]に付与される";
				mes "可能性のある能力は";
				mes "次の通りです。";
				next;
				mes "[セリーヌのリボン[1]]";
				...
				mes "攻撃速度4(攻撃速度+10%)";
				mes "魔力3(Matk+12,詠唱時間-8%)";
				mes "魔力4(Matk+15,詠唱時間-10%)";
				mes "魔力5(Matk+18,詠唱時間-10%)";
				mes "魔力6(Matk+21,詠唱時間-10%)";
				next;
				mes "[セリーヌのリボン[1]]";
				mes "以上です。";
			...
			case 5:
				...
				mes "第1段階として4番目のスロットに、";
				mes "第2段階として3番目のスロットに";
				mes "第3段階として2番目のスロットに";
				mes "エンチャントをすることが";
				mes "できます。";
				next;
				mes "[赤いランタン[1]]";
				mes "エンチャントには失敗する事があり";
				mes "失敗した場合、付与されていた";
				mes "能力は^ff0000初期化されてしまいます^000000。";
				next;
				mes "[赤いランタン[1]]";
				mes "第3段階に挑戦して失敗すると、";
				mes "^ff0000破壊されてしまう^000000";
				mes "場合があります。";
				mes "破壊されたアイテムは";
				mes "無くなってしまいますので";
				mes "注意してください。";
				next;
				mes "[赤いランタン[1]]";
				mes "なお、アクセサリーへのエンチャントは";
				mes "^ff0000任意で初期化を行なう事ができません^000000。";
				next;
				mes "[赤いランタン[1]]";
				mes "また、アクセサリーのエンチャントでは";
				mes "Str、Agi、Dexまたは";
				mes "Int、Vit、Dexのどちらかから";
				mes "ランダムで付与される能力の";
				mes "種類を選択することが出来ます。";
				next;
				mes "[赤いランタン[1]]";
...
xmas.gat,240,294,3	script	ビアード	712,{
	if(BaseLevel < 110) {
		mes "[ビアード]";
		mes "こんな場所に、珍しいな。";
		mes "……同業者か？";
	...
	mes "ふふふ、君は何がしたいんだ？";
	next;
	switch(select("エンチャントがしたい","エンチャントのリセットがしたい","何ができるのですか？","あなたは誰？")) {
	case 1:
		mes "[ビアード]";
		mes "エンチャントだな。";
		mes "どの装備にするんだ？";
		next;
		switch(select("^0000ff古い洋傘^000000","^0000ffシャドウウォーカー[1]^000000","^0000ff瑞々しいバラ^000000","^0000ffセリーヌのリボン^000000","^0000ff優しい心^000000","^0000ff傷ついた心^000000","^0000ff赤いランタン^000000","^0000ff悪霊の糸の手袋^000000")) {
		case 1:
			mes "[ビアード]";
			mes "古い洋傘を";
			mes "装備していない。";
		...
		}
		{
			...
			mes "装備を外してないか？";
			mes "エンチャントしたいアイテムを";
			mes "装備してからもう一度話をかけてくれ。";
			close;
		}
		mes "[ビアード]";
		mes "セリーヌのリボンだな。";
		mes "1回目のエンチャントを始めよう。";
		mes "^0000ff血塗られたコイン15個^000000必要だ。";
		mes "ククク……。";
		next;
		if(select("また今度来ます","続けて下さい") == 1) {
			mes "[ビアード]";
			mes "よく気が変わるやつだな。";
			close;
		}
		delitem 7642, 15;
		@delitem(idx: 118(itemid: unknown), amount: 1)
		getitem 18849, 1;
		mes "[ビアード]";
		mes "うまく成功したようだ。";
		mes "確認してみてくれ";
	...
	case 2:
		...
		mes "どの装備にするんだ？";
		next;
		switch(select("^0000ff古い洋傘^000000","^0000ffシャドウウォーカー[1]^000000","^0000ff瑞々しいバラ^000000","^0000ffセリーヌのリボン^000000")) {
		case 1:
			mes "[ビアード]";
			mes "古い洋傘を";
			mes "装備していない。";
	...
	case 3:
		mes "[ビアード]";
		mes "何が出来るのか？　とても簡単だ。";
		mes "君は血塗られたコインを持ってくる。";
		mes "私はそれを受け取ってから";
		mes "君の装備にエンチャントする。";
		mes "^0000ff一回のエンチャントに必要な";
		mes "血塗られたコインの数は15個だ。^000000";
		next;
		mes "[ビアード]";
		mes "アクセサリー以外は";
		mes "エンチャントのリセットも";
		...
		mes "リセットの詳細に関しては";
		mes "少しルールが細かいから";
		mes "そこにある^ff0000看板^000000をよく見てから";
		mes "依頼をしてくれ。";
		next;
		mes "[ビアード]";
		mes "よく見ないで依頼して";
		mes "^ff0000装備が壊れた^000000と泣きつかれても";
		mes "困るからな。";
		mes "ククク。";
		close;
	case 4:
