...
2941,絶念の魔神の影＠石化攻撃,attack,180,3,1000,0,5000,yes,target,always,0,,,,,,
2941,絶念の魔神の影＠ダークストライク,attack,340,9,1000,0,5000,yes,target,always,0,,,,,,
2941,絶念の魔神の影＠ダークストライク,chase,340,9,1000,0,5000,yes,target,always,0,,,,,,
2941,絶念の魔神の影＠ダークサンダー,attack,341,9,500,0,5000,yes,target,always,0,,,,,,
2941,絶念の魔神の影＠ダークサンダー,chase,341,9,500,0,5000,yes,target,always,0,,,,,,
2942,魔神の巨影＠インビンシブル,idle,685,1,10000,0,60000,no,self,always,0,,,,,,
2942,魔神の巨影＠インビンシブル,chase,685,1,10000,0,60000,no,self,always,0,,,,,,
2942,魔神の巨影＠インビンシブル,attack,685,1,10000,0,60000,no,self,always,0,,,,,,
2942,魔神の巨影＠ダークピアーシング,attack,715,1,10000,0,60000,no,target,always,0,,,,,,
2942,魔神の巨影＠パルスストライク,attack,712,1,10000,0,20000,no,self,always,0,,,,,,
2942,魔神の巨影＠ダンシングブレード,attack,713,1,10000,0,15000,no,target,always,0,,,,,,
...
dali.gat,68,129,3	script	案内板#dali	837,{/* 59131 */
	mes "[インフォメーション]";
	mes "この先";
...
dali02.gat,70,98,3	script	案内板#dali02	837,{/* 59132 */
	mes "[インフォメーション]";
	mes "魔神の塔の入場口を";
	mes "コンパスに表示しますか？";
	mes "　";
	...
	case 1:
		mes "[インフォメーション]";
		mes "コンパス表示を出しました。";
		viewpoint 1, 141, 120, 1, 0x00FF00; //58442
		close;
	case 2:
		mes "[インフォメーション]";
		mes "コンパス表示を消しました。";
		viewpoint 2, 1, 1, 1, 0xFFFFFF; //58442
		close;
	}
}

dali02.gat,51,112,5	script	混乱に陥ったシーフ#cr	939,{/* 59133 */
	mes "[混乱に陥ったシーフ]";
	mes "酒に酔った奴らから金品を";
	mes "盗んでいたら、いつの間にか";
	mes "こんなところに出たんだ。";
...
dali02.gat,68,117,5	script	案内人レシア族#cr	516,{/* 59134 */
	mes "[案内人レシア族]";
	mes "また、ここに出てしまった。";
	mes "出口も見えないなんて……";
	mes "まったく……";
...
dali02.gat,65,119,5	script	観光客レシア族#cr#	516,{/* 59135 */
	mes "[観光客レシア族]";
	mes "ここがあの有名なプロンテラか？";
	mes "やはり大都市！　薄暗いな！";
	close;
...
dali02.gat,69,122,5	script	旅行中レシア族#cr#	516,{/* 59136 */
	mes "[旅行中レシア族]";
	mes "時計の音が聞こえる暗い場所！";
	mes "ここは絶対コモドだよ！";
	close;
...
dali02.gat,65,115,5	script	冒険好きレシア族#cr#	516,{/* 59137 */
	mes "[冒険好きレシア族]";
	mes "みんな、武器を取れ！";
	mes "僕たちはタナトスタワーの";
	mes "真っ只中なんだ！";
...
dali02.gat,45,96,6	script	コンチネンタルガード#ep	707,{/* 59138 */
	mes "[コンチネンタルガード]";
...
dali02.gat,134,119,5	script	歴史学者セフィト#tnm01	729,{/* 59116 */
	mes "[歴史学者セフィト]";
	mes "こんばんは。";
	mes "私はこの先の塔で入手できる";
	mes "武器を研究しています！";
	...
	if(getequippercentrefinery('@i) > rand(100)) {
		successrefitem '@i;
		next;
		emotion 21, "歴史学者セフィト#tnm01"; //59116
		mes "[歴史学者セフィト]";
		mes "さあ、できましたよ！";
		mes "良い物ができましたねっ！";
		close;
		...
		failedrefitem '@i;
		next;
		emotion 23, "歴史学者セフィト#tnm01"; //59116
		mes "[歴史学者セフィト]";
		mes "クホホッ……";
		mes "失敗してしまいました。";
		mes "　";
...
OnInit:
	waitingroom "魔神武器【精錬】",0; //59116
	end;
}
dali02.gat,141,120,3	script	魔神の塔 次元移動機#tnm	10007,{/* 59118 */
	if(checkquest(7577)) {
...
OnStart:
	...
	hideonnpc getmdnpcname("ルシル#tnm01"); //72496
	hideonnpc getmdnpcname("タナトス#tnm01"); //72752
	hideonnpc getmdnpcname("アサシン・ヒュー#tnm01"); //72753
	hideonnpc getmdnpcname("アサシン・リュー#tnm01"); //72754
	hideonnpc getmdnpcname("アサシン・デュー#tnm01"); //60455
	hideonnpc getmdnpcname("アサシン・ヒュー#hui02"); //60459
	hideonnpc getmdnpcname("箱#tnmtop"); //60462
	hideonnpc getmdnpcname("ルシル#tnm04"); //60463
	for(set '@i,1;'@i<=8;set '@i,'@i+1)
		hideonnpc getmdnpcname("#tnmバリケード" +'@i);
	hideonnpc getmdnpcname("#tnm3gate01");
	hideonnpc getmdnpcname("領主の娘#tnm02"); //84731
	hideonnpc getmdnpcname("領主の娘#tnm03"); //84732
	hideonnpc getmdnpcname("#tnm3gate02");
	hideonnpc getmdnpcname("#tnm3gate03");
	hideonnpc getmdnpcname("箱#tnmbosang");
	hideonnpc getmdnpcname("領主の娘#tnm04"); //84739
	hideonnpc getmdnpcname("ロキ#tnmloki02"); //84740
	hideonnpc getmdnpcname("ロキの思念#hidden_loki"); //84741
	hideonnpc getmdnpcname("ロキ#tnmloki03"); //84742
	end;
}

1@tnm1.gat,57,112,5	script	副隊長ハイム#heim0	691,{/* 60431 */
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "[副隊長ハイム]";
		mes "君は？";
		mes "見たところ、私の隊の兵士では";
	...
	mes "この人員での突破は";
	mes "不可能だと思われます。";
	emotion 19, getmdnpcname("偵察兵#tnm01"); //60433
	...
	emotion 9, getmdnpcname("副隊長ハイム#heim0"); //60431
	next;
	mes "[補佐官]";
	mes "……戦力とは言えない人数です。";
	emotion 9, getmdnpcname("補佐官#tnm02"); //60434
...
1@tnm1.gat,56,110,3	script	副隊長ハイム#heim	691,{/* 60432 (hide)*/
	...
	if(TNM1_QUE == 0) {
		...
		next;
		hideoffnpc getmdnpcname("衛生兵ペイマー#feima"); //60435
		mes "[衛生兵ペイマー]";
		mes "うわ～ん！";
		mes "副隊長、助けてくださ～い!!";
		mes "私一人じゃ手が回りませ～ん！";
...
OnStart:
	...
	hideonnpc getmdnpcname("副隊長ハイム#heim0"); //60431
	hideoffnpc getmdnpcname("副隊長ハイム#heim"); //60432
	end;
OnTimer3000:
	initnpctimer;
...
1@tnm1.gat,61,113,3	script	偵察兵#tnm01	997,{/* 60433 */
	mes "[偵察兵]";
	mes "援軍なのか？";
...
1@tnm1.gat,61,110,3	script	補佐官#tnm02	998,{/* 60434 */
	mes "[補佐官]";
...
1@tnm1.gat,47,109,3	script	衛生兵ペイマー#feima	696,{/* 60435 (hide)*/
	if(TNM1_QUE == 1) {
		if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
			mes "[衛生兵ペイマー]";
			mes "今あなた方のリーダーさんと";
		...
		if(select("治療を手伝う","治療をスキップする") == 2) {
			...
			for(set '@i,1;'@i<=7;set '@i,'@i+1) {
				misceffect 6, getmdnpcname("負傷兵#" +'@i+ "_1"); //72482
				hideonnpc getmdnpcname("負傷兵#" +'@i+ "_1"); //72482
				hideoffnpc getmdnpcname("負傷兵#" +'@i); //72481
				misceffect 6, getmdnpcname("負傷兵#" +'@i); //72481
			}
			hideoffnpc getmdnpcname("ルシル#tnm01"); //72496
			hideoffnpc getmdnpcname("タナトス#tnm01"); //72752
			hideoffnpc getmdnpcname("アサシン・ヒュー#tnm01"); //72753
			hideoffnpc getmdnpcname("アサシン・リュー#tnm01"); //72754
		...
		mes "気をつけてくださいね～！";
		emotion 14, getmdnpcname("衛生兵ペイマー#feima"); //60435
...
1@tnm1.gat,39,114,3	script	負傷兵#1	688,{/* 60436 (hide)*/
	mes "[負傷兵]";
	mes "助かりました。";
	mes "ありがとうございます。";
	close;
}
1@tnm1.gat,39,114,3	script	負傷兵#1_1	687,3,3,{/* 60437 */
	if(countitem(7641)) {
		mes "‐負傷兵を治療するには";
		mes "　治療箱が1個必要です‐";
		close;
	...
	mes "‐治療箱に書かれてある方法で";
	mes "　治療を行います……";
	misceffect 72, "負傷兵#1_1"; //60437
	progressbar 2; //color=0xffff00
	delitem 7641, 1;
	misceffect 6, "負傷兵#1_1"; //60437
	hideonnpc "負傷兵#1_1"; //60437
	hideoffnpc "負傷兵#1"; //60436
	misceffect 6, "負傷兵#1"; //60436
...
1@tnm1.gat,30,120,3	script	負傷兵#2	690,{/* 60438 (hide)*/
	mes "[負傷兵]";
	mes "うう……。";
	mes "あんなに痛い治療は";
	mes "二度とゴメンだぜ……。";
...
1@tnm1.gat,30,120,3	script	負傷兵#2_1	689,{/* 60439 */
	if(countitem(7641)) {
		mes "‐負傷兵を治療するには";
		mes "　治療箱が1個必要です‐";
		close;
	...
	mes "‐治療箱に書かれてある方法で";
	mes "　治療を行います……";
	misceffect 72, "負傷兵#2_1"; //60439
	progressbar 2; //color=0xffff00
	delitem 7641, 1;
	misceffect 6, "負傷兵#2_1"; //60439
	hideonnpc "負傷兵#2_1"; //60439
	hideoffnpc "負傷兵#2"; //60438
	misceffect 6, "負傷兵#2"; //60438
	setpartyinmap TNM1_QUE,TNM1_QUE + 1;
	if(TNM1_QUE < 8) {
...
1@tnm1.gat,25,117,5	script	負傷兵#3	693,{/* 60440 (hide)*/
	mes "[負傷兵]";
	mes "助かった……。";
	mes "仲間たちは無事かな……。";
	close;
}
1@tnm1.gat,25,117,5	script	負傷兵#3_1	692,{/* 60441 */
	if(countitem(7641)) {
		mes "‐負傷兵を治療するには";
		mes "　治療箱が1個必要です‐";
		close;
	...
	mes "‐治療箱に書かれてある方法で";
	mes "　治療を行います……";
	misceffect 72, "負傷兵#3_1"; //60441
	progressbar 2; //color=0xffff00
	delitem 7641, 1;
	misceffect 6, "負傷兵#3_1"; //60441
	hideonnpc "負傷兵#3_1"; //60441
	hideoffnpc "負傷兵#3"; //60440
	misceffect 6, "負傷兵#3"; //60440
	setpartyinmap TNM1_QUE,TNM1_QUE + 1;
	if(TNM1_QUE < 8) {
		announce "衛生兵ペイマー : 負傷兵はあと" +(8 - TNM1_QUE)+ "人です!!", 0x9, 0x00ff00;
	}
...
1@tnm1.gat,19,118,4	script	負傷兵#4	695,{/* 60442 (hide)*/
	mes "[負傷兵]";
	mes "もうだめかと思っていたのだが……";
	mes "私は助かったのだな……。";
	close;
}
1@tnm1.gat,19,118,4	script	負傷兵#4_1	694,{/* 60443 */
	if(countitem(7641)) {
		mes "‐負傷兵を治療するには";
		mes "　治療箱が1個必要です‐";
		close;
	...
	mes "‐治療箱に書かれてある方法で";
	mes "　治療を行います……";
	misceffect 72, "負傷兵#4_1"; //60443
	progressbar 2; //color=0xffff00
	delitem 7641, 1;
	misceffect 6, "負傷兵#4_1"; //60443
	hideonnpc "負傷兵#4_1"; //60443
	hideoffnpc "負傷兵#4"; //60442
	misceffect 6, "負傷兵#4"; //60442
	setpartyinmap TNM1_QUE,TNM1_QUE + 1;
	if(TNM1_QUE < 8) {
		announce "衛生兵ペイマー : 負傷兵はあと" +(8 - TNM1_QUE)+ "人です!!", 0x9, 0x00ff00;
	}
...
1@tnm1.gat,19,110,4	script	負傷兵#5	698,{/* 60444 (hide)*/
	mes "[負傷兵]";
	mes "オレ、この戦闘が終わったら";
...
1@tnm1.gat,19,110,4	script	負傷兵#5_1	697,{/* 60445 */
	if(countitem(7641)) {
		mes "‐負傷兵を治療するには";
		mes "　治療箱が1個必要です‐";
		close;
	...
	mes "‐治療箱に書かれてある方法で";
	mes "　治療を行います……";
	misceffect 72, "負傷兵#5_1"; //60445
	progressbar 2; //color=0xffff00
	delitem 7641, 1;
	misceffect 6, "負傷兵#5_1"; //60445
	hideonnpc "負傷兵#5_1"; //60445
	hideoffnpc "負傷兵#5"; //60444
	misceffect 6, "負傷兵#5"; //60444
	setpartyinmap TNM1_QUE,TNM1_QUE + 1;
	if(TNM1_QUE < 8) {
		announce "衛生兵ペイマー : 負傷兵はあと" +(8 - TNM1_QUE)+ "人です!!", 0x9, 0x00ff00;
	}
...
1@tnm1.gat,24,104,7	script	負傷兵#6	10001,{/* 60446 (hide)*/
	mes "[負傷兵]";
	mes "お蔭で以前より良くなったが……";
	mes "動くのにはまだ早いようだ。";
	mes "まあ、生きているだけマシか……。";
...
1@tnm1.gat,24,104,7	script	負傷兵#6_1	699,{/* 60447 */
	if(countitem(7641)) {
		mes "‐負傷兵を治療するには";
		mes "　治療箱が1個必要です‐";
		close;
	...
	mes "‐治療箱に書かれてある方法で";
	mes "　治療を行います……";
	misceffect 72, "負傷兵#6_1"; //60447
	progressbar 2; //color=0xffff00
	delitem 7641, 1;
	misceffect 6, "負傷兵#6_1"; //60447
	hideonnpc "負傷兵#6_1"; //60447
	hideoffnpc "負傷兵#6"; //60446
	misceffect 6, "負傷兵#6"; //60446
	setpartyinmap TNM1_QUE,TNM1_QUE + 1;
	if(TNM1_QUE < 8) {
		announce "衛生兵ペイマー : 負傷兵はあと" +(8 - TNM1_QUE)+ "人です!!", 0x9, 0x00ff00;
	}
...
1@tnm1.gat,31,110,3	script	負傷兵#7	690,{/* 60448 (hide)*/
	mes "[負傷兵]";
	mes "ありがとう！";
	mes "あんたは命の恩人だ。";
	close;
}
1@tnm1.gat,31,110,3	script	負傷兵#7_1	689,{/* 60449 */
	if(countitem(7641)) {
		mes "‐負傷兵を治療するには";
		mes "　治療箱が1個必要です‐";
		close;
	...
	mes "‐治療箱に書かれてある方法で";
	mes "　治療を行います……";
	misceffect 72, getmdnpcname("負傷兵#7_1"); //60449
	progressbar 2; //color=0xffff00
	delitem 7641, 1;
	misceffect 6, getmdnpcname("負傷兵#7_1"); //60449
	hideonnpc getmdnpcname("負傷兵#7_1"); //60449
	hideoffnpc getmdnpcname("負傷兵#7"); //60448
	misceffect 6, getmdnpcname("負傷兵#7"); //60448
	setpartyinmap TNM1_QUE,TNM1_QUE + 1;
	if(TNM1_QUE < 8) {
		announce "衛生兵ペイマー : 負傷兵はあと" +(8 - TNM1_QUE)+ "人です!!", 0x9, 0x00ff00;
	}
...
1@tnm1.gat,46,105,5	script	ルシル#tnm01	667,{/* 60451 (hide)*/
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
	...
	case 8:
		...
		next;
		cutin "tnm_lucile01.bmp", 255;
		emotion 0, getmdnpcname("副隊長ハイム#heim"); //60432
		mes "[副隊長ハイム]";
		mes "どうしてその事を……";
		mes "確かに魔族たちは進行を止め、";
		mes "何かを待っている様子だ。";
		...
		next;
		cutin "tnm_lucile01.bmp", 0;
		emotion 5, getmdnpcname("ルシル#tnm01"); //60451
		mes "[ルシル]";
		mes "……ということらしいですよ。";
		mes "獲物は最上階みたいですが、";
		mes "どうします？";
		...
		hideonnpc getmdnpcname("タナトス#tnm01"); //60452
		next;
		cutin "tnm_lucile01.bmp", 255;
		mes "[副隊長ハイム]";
		mes "な……何をするつもりだ！";
		mes "そんな少人数で乗り込んでも";
		mes "無駄死にするだけだぞ！";
		donpcevent "副隊長ハイム#heim::OnTalk4";
		next;
		cutin "tnm_lucile01.bmp", 0;
		mes "[ルシル]";
		mes "少人数だなんて……";
		...
		donpcevent getmdnpcname("アサシン・デュー#tnm01")+ "::OnStart"; //60455
		next;
		mes "[副隊長ハイム]";
		mes "何を考えているんだ彼らは……。";
		mes "何にせよ厳しい状況だ。";
		...
		hideonnpc getmdnpcname("ルシル#tnm01"); //60451
		hideonnpc getmdnpcname("アサシン・ヒュー#tnm01"); //60453
		hideonnpc getmdnpcname("アサシン・リュー#tnm01"); //60454
		next;
		mes "[副隊長ハイム]";
		mes "魔族を迎撃するだけでも、";
		mes "大きな力になるはずだ。頼むぞ。";
		donpcevent "副隊長ハイム#heim::OnTalk6";
		close;
	}
OnStart:
	initnpctimer;
	hideoffnpc getmdnpcname("ルシル#tnm01"); //60451
	hideoffnpc getmdnpcname("タナトス#tnm01"); //60452
	hideoffnpc getmdnpcname("アサシン・ヒュー#tnm01"); //60453
	hideoffnpc getmdnpcname("アサシン・リュー#tnm01"); //60454
	donpcevent getmdnpcname("衛生兵ペイマー#feima")+ "::OnTalk3";
	end;
OnTimer3000:
	initnpctimer;
	emotion 9, getmdnpcname("ルシル#tnm01"); //60451
	end;
}

1@tnm1.gat,52,104,3	script	タナトス#tnm01	494,{/* 60452 (hide)*/
	cutin "tnm_loki.bmp", 2;
	mes "[タナトス]";
	mes "……。";
	close2;
...
1@tnm1.gat,42,104,5	script	アサシン・ヒュー#tnm01	10002,{/* 60453 (hide)*/
	mes "[アサシン・ヒュー]";
	mes "任務中です。お静かに。";
	close;
}

1@tnm1.gat,44,101,5	script	アサシン・リュー#tnm01	884,{/* 60454 (hide)*/
	//mes "[アサシン・ヒュー]";
	mes "[アサシン・リュー]";
...
1@tnm1.gat,70,108,3	script	アサシン・デュー#tnm01	884,{/* 60455 (hide)*/
	mes "[アサシン・デュー]";
	mes "上の階まで行く道は";
	mes "私がご案内いたします。";
	next;
...
OnTimer3000:
	initnpctimer;
	emotion 9, getmdnpcname("アサシン・デュー#tnm01"); //60455
	end;
}

1@tnm1.gat,91,23,0	script	#tnm1stepmob	139,1,1,{/* 60456 */
OnTouch:
	initnpctimer;
	hideonnpc getmdnpcname("#tnm1stepmob"); //60456
...
1@tnm1.gat,158,24,0	warp	#newwarp_jp	2,2,1@tnm1.gat,124,86	//60457

1@tnm1.gat,138,96,3	script	ルシル#tnm02	667,{/* 60458 */
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "‐何の反応もなく、動かない。";
		mes "　まるで機械人形のようだ‐";
		mes "　";
	...
	case 10:
		...
		hideoffnpc getmdnpcname("アサシン・ヒュー#hui02"); //60459
		end;
	case 11:
		mes "‐ルシルの様子を伺う。";
		mes "　彼女は人の姿をしているが、";
		...
		mes "　彼女の体から、小さく";
		mes "　何かの駆動音が聞こえる……";
		misceffect 202, getmdnpcname("ルシル#tnm02"); //60458
		progressbar 30; //color=0xffff00
	...
	case 12:
		...
		hideonnpc getmdnpcname("ルシル#tnm02"); //60458
		end;
	}
OnTalk1:
...
1@tnm1.gat,135,99,5	script	アサシン・ヒュー#hui02	10002,{/* 60459 (hide)*/
	if(TNM1_QUE != 13) {
		mes "[アサシン・ヒュー]";
		mes "姉さんが心配です……。";
...
OnStart:
	areamonster getmdmapname("1@tnm1.gat"),132,96,149,110,"誘惑の魔神の影",2939,5,getmdnpcname("アサシン・ヒュー#hui02")+ "::OnKilled";
	areamonster getmdmapname("1@tnm1.gat"),132,96,149,110,"猜疑の魔神の影",2940,7,getmdnpcname("アサシン・ヒュー#hui02")+ "::OnKilled";
	areamonster getmdmapname("1@tnm1.gat"),132,96,149,110,"絶念の魔神の影",2941,4,getmdnpcname("アサシン・ヒュー#hui02")+ "::OnKilled";
	end;
OnKilled:
...
1@tnm2.gat,0,0,0	script	#tnm2topmob	128,{/* 60460 */
OnStart:
	initnpctimer;
	end;
OnTimer1000:
...
OnTimer185000:
	misceffect 17, getmdnpcname("タナトス#tnm02"); //94822
	misceffect 90, getmdnpcname("タナトス#tnm02"); //94822
	end;
OnTimer186000:
	donpcevent getmdnpcname("タナトス#tnm02")+ "::OnFail2";
...
1@tnm2.gat,144,137,3	script	ルシル#tnm03	667,{/* 60461 */
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "[ルシル]";
		mes "リーダーと話をしています。";
		mes "少し離れていてください。";
	...
	if(TNM1_QUE == 13) {
		...
		setquest 7573; //state=1
		hideonnpc getmdnpcname("ルシル#tnm03"); //60461
		initnpctimer;
		close2;
		cutin "tnm_lucile01.bmp", 255;
		end;
...
1@tnm2.gat,145,144,3	script	箱#tnmtop	10005,{/* 60462 (hide)*/
	setpartyinmap TNM1_QUE,15;
	misceffect 10, getmdnpcname("箱#tnmtop"); //60462
	hideonnpc getmdnpcname("箱#tnmtop"); //60462
	...
	setarray '@rate,4,4,6,4,6,4,4,4,4,4,4,4,1,1,1,1,1,1;
...
1@tnm2.gat,144,137,3	script	ルシル#tnm04	667,{/* 60463 (hide)*/
	switch(TNM1_QUE) {
	case 14:
...
1@tnm2.gat,136,139,5	script	魔王モロク#tnm01	1916,{/* 60464 */
	end;
OnTalk1:
...
OnTimer8000:
	misceffect 90, getmdnpcname("タナトス#tnm02"); //60465
	end;
OnTimer10000:
	stopnpctimer;
	unittalk "ルシル : 封印に成功……した……？";
	hideonnpc getmdnpcname("タナトス#tnm02"); //60465
	hideonnpc getmdnpcname("魔王モロク#tnm01"); //60464
	hideoffnpc getmdnpcname("箱#tnmtop"); //60462
	hideoffnpc getmdnpcname("ルシル#tnm04"); //60463
	end;
}

1@tnm2.gat,142,139,3	script	タナトス#tnm02	10009,{/* 60465 */
	if(TNM1_QUE == 13) {
		emotion 6, getmdnpcname("タナトス#tnm02"); //60465
		end;
	}
	if(TNM1_QUE == 14) {
...
1@tnm2.gat,109,113,0	script	#tnmバリケード1	1905,{/* 60467 (hide)*/}
1@tnm2.gat,110,112,0	script	#tnmバリケード2	1905,{/* 60468 (hide)*/}
1@tnm2.gat,111,111,0	script	#tnmバリケード3	1905,{/* 60469 (hide)*/}
1@tnm2.gat,112,110,0	script	#tnmバリケード4	1905,{/* 60470 (hide)*/}
1@tnm2.gat,108,113,0	script	#tnmバリケード5	1905,{/* 60471 (hide)*/}
1@tnm2.gat,109,112,0	script	#tnmバリケード6	1905,{/* 60472 (hide)*/}
1@tnm2.gat,110,111,0	script	#tnmバリケード7	1905,{/* 60473 (hide)*/}
1@tnm2.gat,111,110,0	script	#tnmバリケード8	1905,{/* 60474 (hide)*/}

//1@tnm2.gat,135,109,1	script	#ma_fail	844,{/* 60485 (hide)*/}

1@tnm2.gat,21,171,0	script	#tnm3event01	139,1,1,{/* 84727 */
	hideonnpc getmdnpcname("#tnm3event01"); //84727
	announce "女の子の叫び : きゃあああ！　魔族だわ!!　誰か助けて!!", 0x9, 0x00ff00;
	donpcevent getmdnpcname("女の子#tnm01")+ "::OnStart";
	end;
}

1@tnm2.gat,43,175,3	script	女の子#tnm01	941,{/* 84728 */
	set '@count,getmapmobs(getmdmapname("1@tnm2.gat"),getmdnpcname("女の子#tnm01")+ "::OnKilled");
	if('@count > 0) {
		mes "[女の子]";
		mes "どうして城の中に魔族たちが……。";
		mes "助けて下さい!!";
	...
	if(TNM1_QUE == 16) {
		...
		misceffect 35, getmdnpcname("#tnm3gate01"); //84729
		hideoffnpc getmdnpcname("#tnm3gate01"); //84729
		close;
	}
	mes "[領主の娘]";
	mes "あそこに見える本棚が";
...
OnTimer1000:
	monster getmdmapname("1@tnm2.gat"),37,175,"誘惑の魔神の影",2939,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),39,173,"誘惑の魔神の影",2939,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),41,171,"誘惑の魔神の影",2939,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	end;
OnTimer2000:
	monster getmdmapname("1@tnm2.gat"),32,176,"猜疑の魔神の影",2940,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),30,178,"猜疑の魔神の影",2940,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),32,180,"猜疑の魔神の影",2940,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	end;
OnTimer5000:
	monster getmdmapname("1@tnm2.gat"),30,173,"絶念の魔神の影",2941,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),32,175,"絶念の魔神の影",2941,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),34,173,"絶念の魔神の影",2941,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	end;
OnTimer6000:
	set 'flag,1;
	stopnpctimer;
	monster getmdmapname("1@tnm2.gat"),30,184,"絶念の魔神の影",2941,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),32,182,"絶念の魔神の影",2941,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	monster getmdmapname("1@tnm2.gat"),34,180,"絶念の魔神の影",2941,1,getmdnpcname("女の子#tnm01")+ "::OnKilled";
	end;
OnKilled:
	set '@count,getmapmobs(getmdmapname("1@tnm2.gat"),getmdnpcname("女の子#tnm01")+ "::OnKilled");
	if('flag && '@count <= 0) {
...
1@tnm2.gat,50,176,0	warp	#tnm3gate01	1,1,1@tnm3.gat,85,178	//84729

1@tnm3.gat,85,178,0	script	#tnm3event02ect	139,1,1,{/* 84730 */
	hideonnpc getmdnpcname("#tnm3event02ect"); //84730
	hideoffnpc getmdnpcname("領主の娘#tnm02"); //84731
	donpcevent getmdnpcname("領主の娘#tnm02")+ "::OnStart";
	end;
}

1@tnm3.gat,89,179,4	script	領主の娘#tnm02	941,{/* 84731 (hide)*/
	mes "[領主の娘]";
	mes "どうして急にこんなに";
	mes "たくさんの魔族たちが……。";
	close;
...
OnKilled:
	...
	if('flag && '@count <= 0) {
		...
		hideonnpc getmdnpcname("領主の娘#tnm02"); //84731
		hideoffnpc getmdnpcname("領主の娘#tnm03"); //84731
		hideoffnpc getmdnpcname("#tnm3gate02"); //84731
		donpcevent getmdnpcname("絶念の魔神の影#tnm3")+ "::OnStart";
	}
	end;
}

1@tnm3.gat,128,164,3	script	領主の娘#tnm03	941,{/* 84732 (hide)*/
	mes "[領主の娘]";
	mes "ここからは私も詳しくありません。";
	mes "ずっと階段が続きますね……。";
	mes "これほどに魔族が多いのを見ると";
...
1@tnm3.gat,134,156,0	warp	#tnm3gate02	1,1,1@tnm3.gat,169,165	//84733

1@tnm3.gat,179,172,3	script	絶念の魔神の影#tnm3	2941,{/* 84734 */
	end;
OnStart:
	initnpctimer;
	end;
...
OnTimer9000:
	...
	hideonnpc getmdnpcname("絶念の魔神の影#tnm3mob"); //84734
	monster getmdmapname("1@tnm3.gat"),179,172,"絶念の魔神の影",2941,1,getmdnpcname("絶念の魔神の影#tnm3")+ "::OnKilled";
	end;
OnTimer10000:
	monster getmdmapname("1@tnm3.gat"),177,175,"猜疑の魔神の影",2940,1,getmdnpcname("絶念の魔神の影#tnm3")+ "::OnKilled";
	monster getmdmapname("1@tnm3.gat"),179,170,"猜疑の魔神の影",2940,1,getmdnpcname("絶念の魔神の影#tnm3")+ "::OnKilled";
	end;
OnTimer11000:
	set 'flag,1;
	stopnpctimer;
	monster getmdmapname("1@tnm3.gat"),182,172,"誘惑の魔神の影",2939,1,getmdnpcname("絶念の魔神の影#tnm3")+ "::OnKilled";
	monster getmdmapname("1@tnm3.gat"),182,170,"誘惑の魔神の影",2939,1,getmdnpcname("絶念の魔神の影#tnm3")+ "::OnKilled";
	end;
OnKilled:
	set '@count,getmapmobs(getmdmapname("1@tnm3.gat"),getmdnpcname("絶念の魔神の影#tnm3")+ "::OnKilled");
	if('flag && '@count <= 0) {
		misceffect 35, getmdnpcname("#tnm3gate03"); //84735
		hideoffnpc getmdnpcname("#tnm3gate03"); //84735
		donpcevent getmdnpcname("誘惑の魔神の影#tnm3")+ "::OnStart";
	}
	end;
}

1@tnm3.gat,183,177,0	warp	#tnm3gate03	1,1,1@tnm3.gat,97,6	//84735

1@tnm3.gat,97,18,3	script	誘惑の魔神の影#tnm3	2939,{/* 84746 */
	end;
OnStart:
	initnpctimer;
	end;
...
OnTimer7000:
	...
	hideonnpc getmdnpcname("誘惑の魔神の影#tnm3"); //84746
...
1@tnm3.gat,93,52,4	script	モロクの領主#moclord01	106,{/* 84738 */
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "[モロクの領主]";
		mes "ネズミの正体はアサシンか？";
		mes "……他にもいるようだな。";
	...
	misceffect 55, getmdnpcname("ロキ#tnmloki01"); //84736
	next;
	mes "[ロキ]";
	mes "マインドブラスター!!";
	...
	mes "パパを殺さないで!!";
	cutin "ep14_roki01.bmp", 255;
	misceffect 135, getmdnpcname("領主の娘#tnm04"); //84739
	donpcevent getmdnpcname("領主の娘#tnm04")+ "::OnTalk1";
	hideoffnpc getmdnpcname("領主の娘#tnm04"); //84739
	next;
	mes "[ロキ]";
	mes "なっ……!?";
	...
	misceffect 225, getmdnpcname("モロクの領主#moclord01_"); //84738
	next;
	mes "[ロキ]";
	mes "……悪いがお断りだ。";
	...
	close2;
	cutin "ep14_roki01.bmp", 255;
	hideonnpc getmdnpcname("モロクの領主#moclord01_"); //84738
	hideonnpc getmdnpcname("領主の娘#tnm04"); //84739
	hideonnpc getmdnpcname("ロキ#tnmloki01"); //84736
	hideoffnpc getmdnpcname("ロキ#tnmloki02"); //84740
	end;
}

1@tnm3.gat,95,50,4	script	領主の娘#tnm04	941,{/* 84739 (hide)*/
	end;
OnTalk1:
...
1@tnm3.gat,98,47,3	script	ロキ#tnmloki01	512,{/* 84736 */
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "[ロキ]";
		mes "本当に身勝手な奴だな。";
		cutin "ep14_roki01.bmp", 2;
...
OnKilled:
	...
	viewpoint 0, 98, 47, 0, 0xFF0000; //84742
	donpcevent getmdnpcname("#tnm3finaltimer")+ "::OnStop";
	hideonnpc getmdnpcname("ロキ#tnmloki02"); //84740
	hideonnpc getmdnpcname("ロキの思念#hidden_loki"); //84741
	hideoffnpc getmdnpcname("ロキ#tnmloki03"); //84742
	hideoffnpc getmdnpcname("箱#tnmbosang"); //84743
	end;
}
...
1@tnm3.gat,98,47,3	script	ロキ#tnmloki02	512,{/* 84740 (hide)*/
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "[ロキ]";
	...
	if(TNM1_QUE < 18) {
		...
		hideoffnpc getmdnpcname("ロキの思念#hidden_loki"); //84741
		close2;
		cutin "ep14_roki01.bmp", 255;
		end;
	}
	if(checkquest(114800) & 0x8) {
		...
		mes "やつをあるべき場所へ還そう。";
		next;
		hideonnpc getmdnpcname("ロキ#tnmloki02"); //94857
		makemerc 2937,900;
		...
		cutin "ep14_roki01.bmp", 255;
		close2;
		hideoffnpc getmdnpcname("ロキの思念#hidden_loki"); //94858
		end;
	}
	// 未調査
	mes "[ロキ]";
...
1@tnm3.gat,98,47,3	script	ロキの思念#hidden_loki	10043,{/* 84741 (hide)*/
...
1@tnm3.gat,98,47,3	script	ロキ#tnmloki03	512,{/* 84742 (hide)*/
	if(checkquest(114810) & 0x8 == 0) {
		mes "‐ロキに話しかけようとしたその時";
		mes "　不思議な力に身を包まれた。";
		misceffect 35,""; //self
		setquest 114810; //state=1
		compquest 114810;
		misceffect 58,""; //self
		mes "　^0000ff経験値を獲得！^000000‐";
		getexp 500000,0; //99999999
		getexp 500000,0; //99999999
		getexp 0,500000; //2379483
		next;
	}
	mes "[ロキ]";
	mes "……小賢しい。";
