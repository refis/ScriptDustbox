...
har_in01.gat,16,86,4	script	防具屋#rockridge02	50,{/* 59819 */
	...
	mes "一度見ていってください。";
	close2;
	selectshop  'rockridgeitem_id1,'rockridgeitem_num1,'rockridgeitem_val1,
				'rockridgeitem_id2,'rockridgeitem_num2,'rockridgeitem_val2,
				'rockridgeitem_id3,'rockridgeitem_num3,'rockridgeitem_val3;
	end;
OnInit:
	// 詳細未確認
	//if() {							// 1週間経ったか確認
	...
	//case 1:
	//	set 'rockridgeitem_id1,512;
	//	set 'rockridgeitem_num1,10;
	//	set 'rockridgeitem_val1,100000;
	//	set 'rockridgeitem_id2,512;
	//	set 'rockridgeitem_num2,10;
	//	set 'rockridgeitem_val2,500000;
	//	set 'rockridgeitem_id3,512;
	//	set 'rockridgeitem_num3,10;
	//	set 'rockridgeitem_val3,5000;
	//	break;
	//}
	//end;
}
...
harboro1.gat,346,157,6	script	労働意欲に溢れる求職者#	732,{/* 59884 */
	end;
OnTalk1:
	unittalk "労働意欲に溢れる求職者 : 私の腕ならすぐに現場に入れるはずなんだが、なぜ拒否するんだ？";
	end;
}
harboro1.gat,347,155,6	script	労働意欲に溢れる求職者#	733,{/* 59885 */}
harboro1.gat,349,157,6	script	労働意欲に溢れる求職者#	734,{/* 59886 */
	end;
OnTalk1:
	unittalk "労働意欲に溢れる求職者 : 昼寝する為にここに来たとでも思っているのか？　早く仕事をくれ！";
	end;
}
harboro1.gat,351,154,7	script	労働意欲に溢れる求職者#	735,{/* 59887 */}
harboro1.gat,348,148,7	script	労働意欲に溢れる求職者#	753,{/* 59888 */
	end;
OnTalk1:
	unittalk "労働意欲に溢れる求職者 : おい兄さん、ちょっと離れてくれない？　邪魔だよ。";
	end;
}
harboro1.gat,353,156,6	script	労働意欲に溢れる求職者#	755,{/* 59889 */}
harboro1.gat,347,151,7	script	労働意欲に溢れる求職者#	732,{/* 59890 */
	end;
OnTalk1:
	unittalk "労働意欲に溢れる求職者 : ミッドガルドから来た田舎者なのか？　あっちこっちうろちょろしていて目障りだ。";
	end;
}
harboro1.gat,354,149,7	script	労働意欲に溢れる求職者#	733,{/* 59891 */}
harboro1.gat,345,149,7	script	労働意欲に溢れる求職者#	734,{/* 59892 */
	end;
OnTalk1:
	unittalk "労働意欲に溢れる求職者 : どうして私はダメなんだ？　外にいるコヨーテくらいは余裕で倒すことができるんだよ！";
	end;
}
harboro1.gat,352,150,7	script	労働意欲に溢れる求職者#	735,{/* 59893 */}
harboro1.gat,350,149,7	script	労働意欲に溢れる求職者#	753,{/* 59894 */
	end;
OnTalk1:
	unittalk "労働意欲に溢れる求職者 : 牛賊団、コヨーテ討伐パーティーを募集します。";
	end;
}
harboro1.gat,354,153,7	script	労働意欲に溢れる求職者#	732,{/* 59895 */}
...
rockrdg1.gat,195,182,0	script	#好奇心旺盛なコヨーテ01	139,{/* 59987 */}
