...
/* mob_skill
speed 110
3020,フレイムコンドル＠アドレナリンラッシュ,attack,111,1,500,1500,300000,yes,self,always,0,,,,,,
3020,フレイムコンドル＠エモーション,idle,197,1,2000,0,5000,yes,self,always,0,5,,,,,
3020,フレイムコンドル＠風属性攻撃,attack,187,2,500,500,5000,no,target,always,0,,,,,,6

speed 150
3021,フレイムサンドマン＠クローキング,attack,135,1,2000,200,5000,yes,self,always,0,,,,,,
3021,フレイムサンドマン＠クローキング,idle,135,1,2000,200,5000,yes,self,always,0,,,,,,
3021,フレイムサンドマン＠クローキング,chase,135,1,2000,200,5000,yes,self,always,0,,,,,,
3021,フレイムサンドマン＠地属性攻撃,attack,185,3,2000,0,5000,yes,target,always,0,,,,,,
3021,フレイムサンドマン＠砂まき,attack,149,1,500,0,5000,yes,target,always,0,,,,,,
3021,フレイムサンドマン＠クローキング,angry,135,1,2000,200,5000,yes,self,always,0,,,,,,
3021,フレイムサンドマン＠地属性攻撃,angry,185,3,2000,0,5000,yes,target,always,0,,,,,,
3021,フレイムサンドマン＠砂まき,angry,149,1,500,0,5000,yes,target,always,0,,,,,,

speed 130
3022,フレイムフリルドラ＠クローキング,attack,135,1,2000,200,5000,yes,self,always,0,,,,,,
3022,フレイムフリルドラ＠クローキング,chase,135,1,2000,200,5000,yes,self,always,0,,,,,,
3022,フレイムフリルドラ＠クローキング,idle,135,1,2000,200,5000,yes,self,always,0,,,,,,
3022,フレイムフリルドラ＠連続攻撃,attack,171,2,500,700,5000,no,target,always,0,,,,,,6
3022,フレイムフリルドラ＠エモーション,idle,197,1,2000,0,5000,yes,self,always,0,1,,,,,
3022,フレイムフリルドラ＠火属性攻撃,attack,186,3,2000,0,5000,yes,target,always,0,,,,,,

speed 200
3023,フレイムゴーレム＠エモーション,idle,197,1,200,0,5000,yes,self,always,0,9,,,,,
3023,フレイムゴーレム＠スタン攻撃,attack,179,3,500,1500,5000,no,target,always,0,,,,,,6
3023,フレイムゴーレム＠オートガード,attack,249,2,500,0,300000,yes,self,always,0,,,,,,
3023,フレイムゴーレム＠オートガード,chase,249,2,2000,0,300000,yes,self,longrangeattacked,,,,,,,
3023,フレイムゴーレム＠シールドチャージ,attack,250,1,500,1500,5000,no,target,always,0,,,,,,9

speed 400
3026,フレイムピット＠モンスター召喚,dead,209,3,10000,0,0,no,self,always,0,3027,,,,,
...
speed 100
3061,暴虐の箱＠速度強化,attack,350,3,10000,0,30000,yes,self,always,0,,,,,,
3061,暴虐の箱＠速度強化,idle,350,3,10000,0,30000,yes,self,always,0,,,,,,

3105,魔神の使徒・アハト＠石化攻撃,attack,180,10,3000,1000,3000,no,target,always,0,,,,,,
3105,魔神の使徒・アハト＠地属性攻撃,attack,185,10,2000,1000,5000,no,target,always,0,,,,,,
3105,魔神の使徒・アハト＠ヘヴンズドライブ,attack,91,5,2000,1000,20000,yes,target,always,0,,,,,,
3105,魔神の使徒・アハト＠ファイアーピラー,attack,80,10,2000,500,5000,yes,target,always,0,,,,,,
3105,魔神の使徒・アハト＠サイトラッシャー,attack,81,10,1000,500,20000,yes,self,always,,,,,,,
3106,魔神の使徒・シナイム＠インデュア,idle,8,1,2000,0,15000,yes,self,always,0,,,,,,
3106,魔神の使徒・シナイム＠インデュア,chase,8,1,2000,0,15000,yes,self,always,0,,,,,,
3106,魔神の使徒・シナイム＠ライトニングボルト,attack,20,8,2000,3000,5000,no,target,always,0,,,,,,
3106,魔神の使徒・シナイム＠ユピテルサンダー,attack,84,4,2000,0,5000,yes,target,always,0,,,,,,
3106,魔神の使徒・シナイム＠ソウルストライク,attack,13,4,1000,500,5000,no,target,always,0,,,,,,
 */
...
moro_vol.gat,110,90,3	script	参謀アビダル#14302	755,{/* 65265 */
	if(checkquest(7593)) {
		...
		if(checkquest(96435) || checkquest(96436) || checkquest(96437) || checkquest(96438)) {
			mes "[アビダル]";
...
OnTimer15000:
	if('mob1dead > 0) {
		...
		killmonster "moro_vol.gat","#moro_vol_mon::OnKilled1";
		set 'mob1,callmonster("moro_vol.gat",rand(288,296),rand(197,205),"炎火のモロクの現身",3039,"#moro_vol_mon::OnKilled1");
	...
	if('mob2dead > 0) {
		...
		killmonster "moro_vol.gat","#moro_vol_mon::OnKilled2";
		set 'mob2,callmonster("moro_vol.gat",rand(273,281),rand(234,242),"歪んだモロクの現身",3040,"#moro_vol_mon::OnKilled2");
	...
	if('mob3dead > 0) {
		...
		killmonster "moro_vol.gat","#moro_vol_mon::OnKilled3";
		set 'mob3,callmonster("moro_vol.gat",rand(212,220),rand(241,249),"冷気のモロクの現身",3041,"#moro_vol_mon::OnKilled3");
