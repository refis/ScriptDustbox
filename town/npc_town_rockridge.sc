...
harboro1.gat,347,65,3	script	ミズ・マックフィー#rock	74,{/* 59821 */
	...
	if(checkquest(1329)) {
		...
		delquest 1329;
		setquest 1327; //state=1
		mes "[ミズ・マックフィー]";
		mes "ありがとうございます。";
		mes "今回チョロンちゃんが持って行ったの";
		mes "^ff0000帽子^000000です。";
		next;
		mes "[ミズ・マックフィー]";
		mes "町を出てすぐのところに";
		mes "夫がいるので、";
...
harboro1.gat,357,155,3	script	鋼鉄自警団初級受付	880,{/* 59912 */
	...
	if(checkquest(12391)) {	// TODO
		...
		mes "やるべき事を忘れたのか？";
		next;
		if(select("仕事の内容を確認する","^FF0000仕事をキャンセルする^000000") == 2) {	//TODO
			mes "[鋼鉄自警団初級受付]";
			mes "なに？";
			mes "キャンセルしたいのか？";
			mes "キャンセルすると";
